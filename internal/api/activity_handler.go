...
func (h *QueryHandler) fetchAssignmentActivity(ctx context.Context, workspaceID string) []activityItem {
...
func (h *QueryHandler) fetchPeerConversationActivity(ctx context.Context, workspaceID string) []activityItem {
	rows, err := h.db.QueryContext(ctx, `
...
func (h *QueryHandler) fetchEscalationActivity(ctx context.Context, workspaceID string) []activityItem {
	rows, err := h.db.QueryContext(ctx, `
