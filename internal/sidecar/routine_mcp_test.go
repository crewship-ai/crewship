...
func TestRoutinesMCP_ToolsList_ValidSchema(t *testing.T) {
	...
	want := []string{"save_routine", "list_routines", "run_routine", "page_project", "save_page", "discover_capabilities", "workspace_overview", "validate_manifest", "get_routine_draft", "save_routine_draft"}
	if len(got) != len(want) {
