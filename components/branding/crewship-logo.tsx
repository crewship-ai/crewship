 ...
 *
 * SINGLE SOURCE OF TRUTH for the brand mark across the app. The same
 * `<path d="...">` is also baked into the static assets:
 ...
 *
 * If the mark ever changes, edit the path in ALL of those locations so
 * the favicon, inline UI logo, and external assets stay in lockstep.
 *
