...
import { ChevronRight, Box, Plug } from "lucide-react"
  ...
  return (
    <div className="space-y-3">
      <p className="text-[12px] text-muted-foreground -mt-1">
        ...
        with no devcontainer features and no MCP servers. Power users: open a section.
      </p>
...
// =============================================================================
// Image & features — wraps RuntimeConfig
// =============================================================================
...
function ImageFeaturesSection({ state, setState }: { state: WizardState; setState: (p: Partial<WizardState>) => void }) {
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen} className="rounded-lg border border-white/10 bg-card/60 backdrop-blur-sm overflow-hidden">
      <CollapsibleTrigger asChild>
        <button
          type="button"
          className="w-full px-3.5 py-3 flex items-center gap-3 hover:bg-white/[0.02] transition-colors text-left"
        >
...
// =============================================================================
// MCP servers — wraps MCPConfigEditor
// =============================================================================
