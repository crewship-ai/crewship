      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
          <Card>
            <CardContent className="pt-5 space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="crew-name" className="text-label font-medium">Name</Label>
                <Input id="crew-name" value={name} onChange={(e) => onNameChange(e.target.value)} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="crew-desc" className="text-label font-medium">Description</Label>
                <Textarea
                  id="crew-desc"
                  value={description}
          ...
          <Card>
            <CardContent className="pt-5 space-y-3">
              <div>
                <Label className="text-label font-medium">Crew Icon</Label>
        ...
        <div className="space-y-4">
          <Card>
            <CardContent className="pt-5 space-y-3">
              <div>
                <Label className="text-label font-medium">Agent Avatar Style</Label>
                <p className="text-micro text-muted-foreground mt-0.5">
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="h-7 text-label border-amber-300 text-amber-700 hover:bg-amber-50 dark:border-amber-800 dark:text-amber-300 dark:hover:bg-amber-950/30"
                      disabled={applying}
                    ...
                    {applyResult && (
                      <p className={`text-micro ${applyResult.ok ? "text-emerald-600" : "text-destructive"}`}>
