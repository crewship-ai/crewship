              ...
              <section className="flex flex-wrap gap-2">
                {row.crew_id && (
                  <Badge asChild variant="outline" className="text-[10px] font-mono border-border/60">
                    <Link href={`/crews/${row.crew_id}`}>crew · {row.crew_id.slice(0, 8)}</Link>
                  </Badge>
                )}
                {row.agent_id && (
                  <Badge asChild variant="outline" className="text-[10px] font-mono border-border/60">
                    <Link href={`/agents/${row.agent_id}`}>agent · {row.agent_id.slice(0, 8)}</Link>
                  </Badge>
                )}
                {row.mission_id && (
                  <Badge asChild variant="outline" className="text-[10px] font-mono border-border/60">
                    <Link href={`/missions/${row.mission_id}/timeline`}>
