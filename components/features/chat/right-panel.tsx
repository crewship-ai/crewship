      ...
      <div className="space-y-2">
        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap gap-2 text-micro text-muted-foreground">
            {agent.llm_provider && <span className="flex items-center gap-1"><Cpu className="h-3 w-3" />{getProviderLabel(agent.llm_provider)} · {agent.llm_model ? getModelLabel(agent.llm_model) : "default"}</span>}
