    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="shrink-0 flex items-center justify-center gap-2 px-4 py-1.5 text-xs bg-warn/20 dark:bg-warn/30 text-warn dark:text-warn border-b border-warn/40 dark:border-warn"
          role="status"
          aria-live="polite"
        >
          {status === "connecting" ? (
