  ...
  return (
    <div className="flex h-full flex-col min-h-0">
      <header className="border-b border-white/[0.08] p-3 space-y-2 shrink-0">
        ...
        {flagged && reason && (
          <div className="rounded-md border border-destructive/30 bg-destructive/[0.08] px-2 py-1.5 text-xs text-destructive flex items-start gap-1.5">
...
function UninstallSkillDialog({
  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <Button size="sm" variant="ghost" className="px-2 text-destructive hover:text-destructive hover:bg-destructive/[0.08]" aria-label="Uninstall this skill from agents">
