...
export function AnthropicIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.827 3.52h3.603L24 20.48h-3.603l-6.57-16.96zm-7.258 0h3.604L16.742 20.48h-3.603L10.57 13.42H5.16l-2.57 7.06H0L6.569 3.52zm4.132 7.245L8.137 4.616 5.573 10.765h5.128z" />
    </svg>
  )
}
