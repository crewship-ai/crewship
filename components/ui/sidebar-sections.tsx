...
// Section primitives — Header / Footer / Separator / Content + the
// Group family. Extracted from sidebar.tsx for readability; all
// exports stay reachable from the original "@/components/ui/sidebar"
// barrel.
