...
The milestone CLI is nested under [`crewship project`](/cli/project) because milestones are children of a project. There is no standalone `crewship milestone` root command. <!-- docs-inventory: ignore -->
