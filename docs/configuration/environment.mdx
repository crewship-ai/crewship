...
| `CREWSHIP_RUNTIME_IMAGE` | `debian:bookworm-slim` | Agent runtime Docker image. Any glibc-based Linux image works — Crewship bind-mounts the sidecar and entrypoint at runtime. |
