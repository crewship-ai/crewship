...
ipc:
  socket_path: "/tmp/crewship.sock"  # Unix socket for internal API. Default only
                                     # when CREWSHIP_DATA_DIR is unset or is the
                                     # packaged /var/lib/crewship; any other data
                                     # dir defaults to <dataDir>/crewship.sock.
