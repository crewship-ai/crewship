...
- **`/routines` page** — dedicated full-management surface. Originally a three-column clone of `/orchestration`; since #2519 it is one list (Routines / Calendar / Recent runs) and a detail with Overview / History / Plan / Versions plus a page editor at `?view=edit`.
