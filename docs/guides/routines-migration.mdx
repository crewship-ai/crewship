...
The original PR review flagged 23 inline issues. The vast majority were addressed in the original `7715ee7` sweep; the remaining items shipped with this release. See the [CHANGELOG](/CHANGELOG.md) for the full list, or [PIPELINES.md §17.5](./../../.claude/context/prd/PIPELINES.md) for the bug-list with rationale per fix.
...
See [PIPELINES.md §17.7](./../../.claude/context/prd/PIPELINES.md) for the full deferred-features list and the rationale per item.
