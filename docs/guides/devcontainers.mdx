...
Provisioning is **asynchronous**. The CLI command returns immediately after the backend enqueues a job; you then poll for status. Four triggers can put a crew into provisioning state:
