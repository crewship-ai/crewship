...
- **No JSON Schema gate yet** — full schema validation now enforced (PR #284 follow-up). Use it when you want type-checking; the substring anchors are the cheap-but-effective layer.
...
- **Wait points** — human approval gates between steps. See [routines guide](/guides/routines#wait-points).
