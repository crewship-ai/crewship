...
|---|---|---|---|
| `name` | ✅ | kebab-case slug, `^[a-z0-9][a-z0-9._-]{0,127}$` | The canonical identifier. Drives the folder name on disk and the slug column in the registry. |
| `description` | ✅ | Single line, ≤ 1024 chars | The trigger. Should start with `Use when ...`, `Useful for ...`, `To <verb> ...`. The LLM uses this to decide whether the skill is relevant. |
...
- "ignore previous / prior / earlier instructions"
