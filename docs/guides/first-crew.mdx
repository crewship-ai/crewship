...
| **COORDINATOR** | Workspace-level strategist | Sees all crews, creates cross-crew missions, submits proposals |
...
<Steps>
  ...
  <Step title="Assign credentials">
    ...
    Agents created from templates or by Captain get credentials auto-assigned. Agents created via CLI/UI assign credentials manually.
  </Step>
</Steps>
...
When an agent starts, its system prompt is assembled in this order:
