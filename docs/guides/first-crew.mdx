...
<Steps>
  ...
  <Step title="Assign credentials">
    ...
    Agents created from templates get credentials auto-assigned. Agents created via CLI/UI assign credentials manually. (Captain-based creation is deprecated — see [Captain guide](/guides/captain).)
  </Step>
</Steps>
