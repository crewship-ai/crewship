...
The same dial governs the [`crewship` step](/guides/routines#crewship-act-on-crewships-own-nouns) — a routine writing back into Crewship's own nouns. Three more actions:
