...
These map 1:1 to `POST` / `GET` / `DELETE /api/v1/chats/{chatId}/participants`.
...
- **Presence / typing indicators and `@mention` autocomplete are not shipped
  yet** — mention the slug by hand. Live message sync works today.
