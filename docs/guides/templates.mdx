...
Crew templates create a complete team in one step -- a crew with pre-configured agents, roles, system prompts, and skill assignments. Captain can deploy them with the `apply_crew_template` tool.
