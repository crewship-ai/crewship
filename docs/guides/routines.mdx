...
**Delivery is asynchronous.** The endpoint verifies the signature, rate limit, and governance status synchronously, reserves a run id, then answers immediately:
