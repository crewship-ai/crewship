...
| `GENERATED` | Machine-originated — an agent authored it, memory promoted it, or `skill create` drafted it (see [Agent-authored skills](/guides/skills-agent-authored)) |
