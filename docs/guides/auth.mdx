...
| `POST` | `/api/v1/auth/signup` | Create a new user account. Gated by the `CREWSHIP_ALLOW_SIGNUP` server flag; disabled by default for self-hosted installs (returns **403** when off). |
