...
| Backup | `backup.chain_resigned` — a forked restore re-signed this workspace's hash chain at a new genesis. See [Backup & restore](/guides/backup#forked-restores-re-sign-the-journal-chain). |
