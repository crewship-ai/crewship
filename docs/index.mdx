...
description: "Self-hosted runtime for AI coding agents. Per-crew Linux containers, runs entirely on your hardware, full backup by default — code, data, conversations, cost ledger."
icon: "house"
---
...
| Containers | Docker (default), [Apple Containers](/guides/macos-without-docker) on macOS 26 (Tahoe) or later; Kubernetes on the v0.2 roadmap |
