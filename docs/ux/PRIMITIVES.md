...
- 2026-09-04 · cluster C · `lib/entity-links.ts` — `pages` ref (`crewSlug`) for the pages list; `components/features/crews/crew-links.ts` builds a crew's §5 link row through entityHref.
