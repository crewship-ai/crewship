...
| `user_models` (disk file) | `/crew/shared/.memory/users/{user_slug}.md` in the subject's most-active crew | Best-effort — `outputBasePath` must be configured. Failures logged but do not block the DB delete. |
