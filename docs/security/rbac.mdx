...
<CardGroup cols={3}>
  ...
  <Card title="COORDINATOR (deprecated)" icon="globe">
    *Deprecated 2026-04-16.* Workspace strategist. Sees all crews, creates cross-crew missions, submits proposals for human approval. See [Coordinator guide](/guides/coordinator).
  </Card>
</CardGroup>
