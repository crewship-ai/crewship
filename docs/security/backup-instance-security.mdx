...
Crew-scope and workspace-scope backups are already documented in
[`BACKUP.md`](../.claude/context/prd/BACKUP.md) — this page is
specifically about the instance scope's additional risks.
