...
[Backup & Restore guide](/guides/backup); the design rationale, format
versioning, and v1.5 / v2 roadmap live in the
[BACKUP.md PRD](https://github.com/crewship-ai/crewship/blob/main/.claude/context/prd/BACKUP.md).
This page is specifically about the instance scope's additional risks.
