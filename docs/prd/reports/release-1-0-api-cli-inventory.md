...
| CLI commands | 729 | 729 exact mentions, 729 root pages present, 0 root pages missing | 715 with a test signal |
...
Docs → code references: 3899 commands, 1973 API paths, 395 environment variables, 209 manifest kinds, and 1806 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
