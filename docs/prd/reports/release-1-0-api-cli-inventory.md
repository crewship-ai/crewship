...
|---|---:|---|---|
| API operations | 588 | 588 exact, 0 resource-level, 0 missing | 439 with a test signal |
| CLI commands | 800 | 800 exact mentions, 800 root pages present, 0 root pages missing | 785 with a test signal |
...
Docs → code references: 4428 commands, 2175 API paths, 440 environment variables, 230 manifest kinds, and 2141 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
