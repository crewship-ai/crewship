...
|---|---:|---|---|
| API operations | 552 | 552 exact, 0 resource-level, 0 missing | 417 with a test signal |
...
Docs → code references: 4082 commands, 2047 API paths, 420 environment variables, 209 manifest kinds, and 1896 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
