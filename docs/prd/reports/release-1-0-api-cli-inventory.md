...
Response schema quality: 518 API operations have a concrete 2xx schema; 4 still use the generic object fallback.

Request schema quality: 225 operations have request bodies; 220 have concrete JSON schemas, 3 use non-JSON media types, and 2 still use a generic JSON fallback.
