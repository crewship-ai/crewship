...
|---|---:|---|---|
| API operations | 582 | 582 exact, 0 resource-level, 0 missing | 435 with a test signal |
| CLI commands | 788 | 788 exact mentions, 788 root pages present, 0 root pages missing | 773 with a test signal |

Response schema quality: 567 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
Docs → code references: 4341 commands, 2153 API paths, 425 environment variables, 229 manifest kinds, and 2045 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
