...
|---|---:|---|---|
| API operations | 531 | 531 exact, 0 resource-level, 0 missing | 367 with a test signal |
| CLI commands | 723 | 723 exact mentions, 723 root pages present, 0 root pages missing | 709 with a test signal |

Response schema quality: 224 API operations have a concrete 2xx schema; 307 still use the generic object fallback.
