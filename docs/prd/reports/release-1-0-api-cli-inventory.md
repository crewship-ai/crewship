...
|---|---:|---|---|
| API operations | 588 | 588 exact, 0 resource-level, 0 missing | 446 with a test signal |
| CLI commands | 827 | 827 exact mentions, 827 root pages present, 0 root pages missing | 812 with a test signal |
...
CLI flag quality: 390 commands define flags; 390 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 105 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4594 commands, 2210 API paths, 454 environment variables, 231 manifest kinds, and 2202 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
