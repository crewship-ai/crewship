...
| CLI commands | 828 | 828 exact mentions, 828 root pages present, 0 root pages missing | 813 with a test signal |
...
CLI flag quality: 391 commands define flags; 391 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 105 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4601 commands, 2233 API paths, 454 environment variables, 231 manifest kinds, and 2203 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
