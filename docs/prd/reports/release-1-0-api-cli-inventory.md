...
|---|---:|---|---|
| API operations | 548 | 548 exact, 0 resource-level, 0 missing | 414 with a test signal |
...
Docs → code references: 4032 commands, 2028 API paths, 401 environment variables, 209 manifest kinds, and 1872 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
