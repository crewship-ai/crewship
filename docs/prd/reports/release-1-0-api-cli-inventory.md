...
| CLI commands | 740 | 740 exact mentions, 740 root pages present, 0 root pages missing | 721 with a test signal |
...
Docs → code references: 3952 commands, 2007 API paths, 395 environment variables, 209 manifest kinds, and 1837 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
