...
| CLI commands | 793 | 793 exact mentions, 793 root pages present, 0 root pages missing | 778 with a test signal |
...
Docs → code references: 4381 commands, 2158 API paths, 427 environment variables, 229 manifest kinds, and 2066 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
