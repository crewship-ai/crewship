...
|---|---:|---|---|
| API operations | 536 | 536 exact, 0 resource-level, 0 missing | 401 with a test signal |
| CLI commands | 730 | 730 exact mentions, 730 root pages present, 0 root pages missing | 715 with a test signal |
...
Docs → code references: 3900 commands, 1976 API paths, 395 environment variables, 209 manifest kinds, and 1809 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
