...
| CLI commands | 786 | 786 exact mentions, 786 root pages present, 0 root pages missing | 771 with a test signal |
...
CLI flag quality: 375 commands define flags; 375 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 102 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4311 commands, 2155 API paths, 425 environment variables, 229 manifest kinds, and 1993 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
