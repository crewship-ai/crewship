...
|---|---:|---|---|
| API operations | 588 | 588 exact, 0 resource-level, 0 missing | 445 with a test signal |
| CLI commands | 822 | 822 exact mentions, 822 root pages present, 0 root pages missing | 807 with a test signal |
...
CLI flag quality: 389 commands define flags; 389 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 105 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4577 commands, 2206 API paths, 454 environment variables, 231 manifest kinds, and 2197 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
