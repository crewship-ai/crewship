...
| CLI commands | 823 | 823 exact mentions, 823 root pages present, 0 root pages missing | 808 with a test signal |
...
Docs → code references: 4584 commands, 2229 API paths, 454 environment variables, 231 manifest kinds, and 2198 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
