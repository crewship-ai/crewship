...
|---|---:|---|---|
| API operations | 536 | 536 exact, 0 resource-level, 0 missing | 406 with a test signal |
...
Request schema quality: 224 operations have request bodies; 220 have concrete JSON schemas, 4 use non-JSON media types, and 0 still use a generic JSON fallback.
...
Docs → code references: 3920 commands, 1984 API paths, 401 environment variables, 209 manifest kinds, and 1814 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
