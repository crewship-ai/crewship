...
|---|---:|---|---|
| API operations | 545 | 545 exact, 0 resource-level, 0 missing | 408 with a test signal |
| CLI commands | 742 | 742 exact mentions, 742 root pages present, 0 root pages missing | 722 with a test signal |

Response schema quality: 531 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
CLI flag quality: 350 commands define flags; 350 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 99 discovered, 0 missing documentation. Manifest kinds: 20 discovered, 0 missing documentation.

Docs → code references: 3978 commands, 2011 API paths, 395 environment variables, 209 manifest kinds, and 1845 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
