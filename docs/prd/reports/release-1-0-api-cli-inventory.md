...
|---|---:|---|---|
| API operations | 588 | 588 exact, 0 resource-level, 0 missing | 442 with a test signal |
| CLI commands | 801 | 801 exact mentions, 801 root pages present, 0 root pages missing | 786 with a test signal |
...
Docs → code references: 4431 commands, 2166 API paths, 432 environment variables, 230 manifest kinds, and 2091 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
