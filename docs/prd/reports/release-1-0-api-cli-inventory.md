...
|---|---:|---|---|
| API operations | 539 | 539 exact, 0 resource-level, 0 missing | 402 with a test signal |
| CLI commands | 735 | 735 exact mentions, 735 root pages present, 0 root pages missing | 716 with a test signal |

Response schema quality: 525 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
Docs → code references: 3912 commands, 1987 API paths, 395 environment variables, 209 manifest kinds, and 1806 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
