...
| CLI commands | 821 | 821 exact mentions, 821 root pages present, 0 root pages missing | 806 with a test signal |
...
CLI flag quality: 388 commands define flags; 388 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 105 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4571 commands, 2200 API paths, 454 environment variables, 231 manifest kinds, and 2191 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
