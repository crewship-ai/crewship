...
| CLI commands | 783 | 783 exact mentions, 783 root pages present, 0 root pages missing | 768 with a test signal |
...
Docs → code references: 4271 commands, 2145 API paths, 425 environment variables, 228 manifest kinds, and 1978 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
