...
|---|---:|---|---|
| API operations | 583 | 583 exact, 0 resource-level, 0 missing | 434 with a test signal |
| CLI commands | 785 | 785 exact mentions, 785 root pages present, 0 root pages missing | 770 with a test signal |

Response schema quality: 568 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
CLI flag quality: 374 commands define flags; 374 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 102 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4304 commands, 2152 API paths, 425 environment variables, 229 manifest kinds, and 1987 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
