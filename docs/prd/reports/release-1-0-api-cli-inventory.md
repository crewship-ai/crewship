...
|---|---:|---|---|
| API operations | 532 | 532 exact, 0 resource-level, 0 missing | 402 with a test signal |
| CLI commands | 726 | 726 exact mentions, 726 root pages present, 0 root pages missing | 712 with a test signal |

Response schema quality: 518 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
