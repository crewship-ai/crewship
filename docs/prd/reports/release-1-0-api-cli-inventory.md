...
| CLI commands | 818 | 818 exact mentions, 818 root pages present, 0 root pages missing | 803 with a test signal |
...
CLI flag quality: 387 commands define flags; 387 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 102 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4564 commands, 2219 API paths, 447 environment variables, 231 manifest kinds, and 2185 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
