...
| CLI commands | 784 | 784 exact mentions, 784 root pages present, 0 root pages missing | 769 with a test signal |
...
CLI flag quality: 373 commands define flags; 373 document all of their flags and 0 still have undocumented flag(s).

Environment variables: 102 discovered, 0 missing documentation. Manifest kinds: 21 discovered, 0 missing documentation.

Docs → code references: 4275 commands, 2148 API paths, 425 environment variables, 228 manifest kinds, and 1979 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
