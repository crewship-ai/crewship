...
|---|---:|---|---|
| API operations | 540 | 540 exact, 0 resource-level, 0 missing | 405 with a test signal |
| CLI commands | 734 | 734 exact mentions, 734 root pages present, 0 root pages missing | 720 with a test signal |

Response schema quality: 526 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
Docs → code references: 3883 commands, 1982 API paths, 394 environment variables, 209 manifest kinds, and 1800 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
