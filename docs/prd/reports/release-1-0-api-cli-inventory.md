...
|---|---:|---|---|
| API operations | 535 | 535 exact, 0 resource-level, 0 missing | 400 with a test signal |
| CLI commands | 728 | 728 exact mentions, 728 root pages present, 0 root pages missing | 714 with a test signal |

Response schema quality: 521 API operations have a concrete 2xx schema; 0 still use the generic object fallback.
...
Docs → code references: 3874 commands, 1969 API paths, 394 environment variables, 209 manifest kinds, and 1797 flags; missing symbols: 0, 0, 0, 0, and 0 respectively.
