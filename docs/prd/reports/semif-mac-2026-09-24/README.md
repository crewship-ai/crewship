...
Archived standalone evaluation. The server implementation in closed
[PR #2630](https://github.com/crewship-ai/crewship/pull/2630) was not merged;
Crewship `main` has no local decision evaluator. See the
