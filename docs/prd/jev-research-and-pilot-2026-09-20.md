...
> **Archivní stav (25. 9. 2026):** Tato zpráva popisuje historickou větev
> [PR #2630](https://github.com/crewship-ai/crewship/pull/2630), uzavřenou bez
> sloučení. Popsané CLI a serverové kroky nejsou součástí `main`. Měření a
> podklady zůstávají pro případné nové, samostatně posouzené řešení. Viz
> [rozcestník archivu](decision-models-archive.md).
...
## Co bylo implementováno pouze v uzavřené větvi
