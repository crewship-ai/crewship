...
> **Historical branch only:** [PR #2630](https://github.com/crewship-ai/crewship/pull/2630)
> closed without merging on 2026-09-25. The `decision` routine step, hosted
> evaluator and frontend described here are absent from `main`. This record
> is retained for a future local or hosted implementation; see the
> [archive index](decision-models-archive.md).
