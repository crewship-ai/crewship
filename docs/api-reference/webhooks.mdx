...
This path still works during the deprecation window but is going away. Requests authenticated this way receive `Deprecation` and `Sunset: Wed, 31 Dec 2026 23:59:59 GMT` response headers.
