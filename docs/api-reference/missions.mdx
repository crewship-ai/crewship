...
<Note>
  Mission proposals were created by the deprecated Captain and COORDINATOR
  flows (see [Captain](/guides/captain), [Coordinator](/guides/coordinator)).
  The proposals endpoints are retained for potential reuse in future
  human-in-the-loop approval flows.
</Note>

Agents (typically COORDINATOR role — deprecated) can propose missions that require human approval before execution.
