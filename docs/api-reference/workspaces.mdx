...
| `POST` | [`/api/v1/workspaces/{workspaceId}/pipelines/test_run`](#test-run-a-draft) | Run an unsaved draft DSL |
| `POST` | [`/api/v1/workspaces/{workspaceId}/pipelines/{slug}/dry_run`](#dry-run-a-saved-pipeline) | WouldExecute report, no agent runs |
