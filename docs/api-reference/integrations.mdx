...
| `GET` | [`/api/v1/agents/{agentId}/resolved-integrations`](#resolve-agent-integrations) | Resolve effective integrations |
...
```
GET /api/v1/agents/{agentId}/resolved-integrations?workspace_id={workspaceId}
```
