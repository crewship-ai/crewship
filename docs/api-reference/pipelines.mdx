...
still answers synchronously with the usual status code. Comparisons, Inbox
**Retry** and slash-command runs use this header.
...
moves that one pending start rather than adding another), or `"manual"` (an
