...
|---|---|---|---|
| GET | `/api/v1/workspaces/{workspaceId}/pipeline-schedules` | member | `200` and a JSON array; optional `limit` (1–500) and `offset` (0–1000000) |
...
[save door](/api-reference/workspaces#save-pipeline).
