...
<Note>
Most read endpoints accept a session or CLI token with workspace membership; import, generate, delete, and template mutations require a `MANAGER`+ role as noted per endpoint.
</Note>
