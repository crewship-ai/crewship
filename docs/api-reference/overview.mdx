...
### Captain (Workspace AI Assistant)

| Endpoint | Method | Description |
|---|---|---|
| `/api/v1/captain/chat` | POST | Send message to Captain (SSE streaming response) |
| `/api/v1/captain/context` | GET | Get workspace context (phase, counts) |
| `/api/v1/captain/history` | GET | Load Captain conversation history |
| `/api/v1/captain/history` | DELETE | Clear Captain conversation history |
