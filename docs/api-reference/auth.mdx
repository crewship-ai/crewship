...
upload + an authenticated serve endpoint and is tracked as a follow-up.
The field is returned by `PATCH /users/me` but is currently only
populated by Google sign-in.
</Note>
