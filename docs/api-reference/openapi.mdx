...
<Note>
  ...
  587 of 604 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 17 have no success body at all. 259 operations carry a request body: 255 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
