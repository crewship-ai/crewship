...
<Note>
  ...
  636 of 660 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 24 have no success body at all. 283 operations carry a request body: 279 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
