...
<Note>
  ...
  593 of 614 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 21 have no success body at all. 264 operations carry a request body: 260 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
