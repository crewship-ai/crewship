...
<Note>
  ...
  602 of 623 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 21 have no success body at all. 269 operations carry a request body: 265 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
