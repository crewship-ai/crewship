...
<Note>
  ...
  581 of 596 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 15 have no success body at all. 255 operations carry a request body: 251 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
