...
<Note>
  ...
  611 of 635 operations return a named 2xx schema, 0 fall back to an unconstrained `object`, and 24 have no success body at all. 272 operations carry a request body: 268 with a named JSON schema, 4 with a non-JSON media type, and 0 with a generic JSON fallback.
