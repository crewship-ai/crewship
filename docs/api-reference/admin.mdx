...
| `rows_deleted` | `int` | Sum of rows that went **away**. Rows the cascade only anonymised or reassigned (`page_versions_anonymised`, `pages_transferred`) are excluded — nothing was deleted there. |
