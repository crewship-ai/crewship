...
# Note: `/fleet-status` is the historical endpoint name from before the
# Crews UI rename. Response is a per-workspace aggregate counting agents
# by status (IDLE/RUNNING/ERROR/STOPPED). Drives the 'Crews idle/online'
