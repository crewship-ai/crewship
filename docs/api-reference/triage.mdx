---
title: "Triage Rules"
description: "Pattern-matching rules that auto-assign new backlog issues to a crew / agent / project + tag them with priority and labels. List, create, update, delete, and a one-shot Process endpoint that runs all enabled rules against the current backlog."
icon: "list-checks"
---
