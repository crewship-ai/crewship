...
Sibling design with [`crewship explain`](/cli/agent):
...
- [`crewship explain`](/cli/agent) — LLM-summarised narrative of the same data.
- [`crewship history`](/cli/agent) — list recent runs to find a run ID.
