...
# prun_zzzzzz       viktor     COMPLETED  pipeline           2026-05-19 13:00     2026-05-19 13:01
```
...
| `--crew <slug-or-id>` | — | Only this crew's runs. Resolved the same way; sent as `crew_id`. Combines with `--agent` (AND). |
