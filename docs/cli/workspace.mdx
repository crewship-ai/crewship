...
- [`crewship admin`](/cli/admin) — cross-workspace operations (only OWNER on the workspace itself, or instance admin).
- [Workspaces API](/api-reference/workspaces/list) — `GET /api/v1/workspaces`.
