...
Manage the lifecycle-hook registry -- scripts or webhooks that fire on platform events (`assignment.completed`, `on_approval_requested`, `keeper.decision`, ...). See the [Hooks guide](/guides/hooks) for event catalog and handler kinds.
