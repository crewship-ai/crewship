...
<Note>
A crew at `autonomy_level: strict` ignores standing grants entirely — strict means every governable action reaches an operator, regardless of what has been granted.
</Note>
