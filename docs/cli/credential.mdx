...
| `--provider` | `string` | | Provider: `ANTHROPIC`, `OPENAI`, `GOOGLE`, `CURSOR`, `FACTORY`, `GITHUB`, `GITLAB`, `VERCEL`, `AWS`, `CUSTOM_CLI`, `NONE`. |
...
| Flag | Type | Default | Description |
|------|------|---------|-------------|
| `--provider` | `string` | _(required unless SECRET)_ | Provider: `ANTHROPIC`, `OPENAI`, `GOOGLE`, `CURSOR`, `FACTORY`, `GITHUB`, `GITLAB`, `VERCEL`, `AWS`, `CUSTOM_CLI`. |
