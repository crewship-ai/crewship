...
# Run a tiny init as PID 1 to reap zombies (docker --init)
crewship crew config <slug-or-id> --init
...
| `--init` | `bool` | `false` | Run a tiny init as PID 1 (docker `--init`) to reap zombie processes. |
