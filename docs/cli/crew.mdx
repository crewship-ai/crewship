...
|---|---|---|
| `runtime.agent_min_memory_mb` | `2048` | Memory one agent needs. Also the divisor behind a crew's concurrent-run budget — a crew's memory divided by this is how many agents may run at once. |
