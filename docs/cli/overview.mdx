...
Anywhere a command takes an agent, crew, skill, or credential reference, you can pass a
slug, a display name, or the record id interchangeably — including slugs that happen to
