...
| `move <page> --folder <slug>\|--unfiled` | Move a page into a folder, or out of the one it is in |
...
| Flag | Description |
|---|---|
| `--me` | Ask about yourself. Required: this command answers about you, and who else reaches a page is `page folder acl` and `page grants`. |
...
creation. An admin, or the owning crew's MANAGER (or higher).
