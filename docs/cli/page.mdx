...
| `4` | You are not the panel's declared producer and hold no `produce` grant (but can reach the page), or you are not authenticated | A 403 here is journalled and notifies the page owner |
