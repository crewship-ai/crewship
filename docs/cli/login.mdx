...
| `--password-stdin` | bool | `false` | Reads the password as a line from stdin instead of prompting on the TTY. Mutually exclusive with `CREWSHIP_PASSWORD`. |
