...
| 10c. Pages | Page specs, demo payloads, then one run of every routine a panel names as producer — skipping a pack whose requirement is unmet | Fatal on spec, non-fatal per run |
