...
- **`invalid services_json: services["xyz"]: name must be a DNS label`** — service names must match `[a-z][a-z0-9-]{0,30}[a-z0-9]` since they become bridge-network DNS aliases.
