...
The **Dashboard** (`/`) shows **Needs your attention**, **Results & review** (live work and recent outcomes), **Up next** (scheduled runs), and **Your crews**. Below them, **Agent run summary** and **Run volume by crew** follow the sticky 24h / 7d / 30d selector, with **Pages** alongside the chart. Create issues and chat from their dedicated sections.
