...
- **Docker** — one Linux container per crew, shared by its agents. On macOS you can run [Apple Containers instead of Docker Desktop](/guides/macos-without-docker) (macOS 26 / Tahoe or later), with some feature loss
