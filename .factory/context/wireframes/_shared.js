          ...
          '<div class="px-4 py-3 border-b border-neutral-100">' +
            '<div class="flex items-center gap-3">' +
              ...
              '<div>' +
                ...
                '<div class="text-xs text-neutral-400">pavel@unifylab.cz</div>' +
              '</div>' +
            '</div>' +
