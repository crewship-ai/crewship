...
export default function CrewDetailPage() {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (res.ok) { toast.success(`"${crew.name}" deleted`); router.push("/cruise/crews") }
    ...
    return (
      <div className="p-6 space-y-4">
        <Button variant="ghost" size="sm" asChild>
          <Link href="/cruise/crews"><ArrowLeft className="mr-2 h-4 w-4" />Back to Crews</Link>
        </Button>
      ...
      <ToolbarStrip
        ...
        leading={
          <Button variant="ghost" size="sm" asChild className="h-7 px-2 gap-1">
            <Link href="/cruise/crews"><ArrowLeft className="h-3.5 w-3.5" /><span className="text-micro">Back</span></Link>
          </Button>
        }
        ariaLabel="Crew tabs"
      />
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" asChild>
            <Link href={`/cruise/crews/${crew.id}/files`}>
