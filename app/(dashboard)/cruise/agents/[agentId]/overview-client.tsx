  ...
  if (error || !agent) {
    return (
      <div className="p-6">
        ...
        >
          <div className="mt-4">
            <Link href="/cruise" className="text-micro font-medium text-primary hover:underline">
              Back to Cruise
            </Link>
          </div>
        </EmptyState>
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        <StatMiniCard
          href={`/cruise/agents/${agentId}/runs`}
          icon={Zap}
          label="Runs"
          value={totalRuns}
        ...
        />
        <StatMiniCard
          href={`/cruise/agents/${agentId}/sessions`}
          icon={MessagesSquare}
          label="Sessions"
        ...
        />
        <StatMiniCard
          href={`/cruise/agents/${agentId}/tools?section=skills`}
          icon={Puzzle}
          label="Skills"
        ...
        />
        <StatMiniCard
          href={`/cruise/agents/${agentId}/tools?section=credentials`}
          icon={KeyRound}
          label="Credentials"
        ...
        />
        <StatMiniCard
          href={`/cruise/agents/${agentId}/workspace?pane=files`}
          icon={FileText}
          label="Files"
          value="\u2014"
              ...
              <div className="space-y-2.5 text-body">
                ...
                {agent.crew && (
                  <div className="flex items-center justify-between">
                    ...
                    <Link href={`/cruise/crews/${agent.crew_id}`} className="flex items-center gap-1.5 hover:underline" aria-label={`Go to ${agent.crew.name} crew`}>
          ...
          <Card>
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-4 py-3 border-b">
                ...
                <Link href={`/cruise/agents/${agentId}/chat`} className="text-micro text-primary font-medium hover:underline">
                  View all
                </Link>
              </div>
              {recentChats.length === 0 ? (
                ...
                <div className="divide-y">
                  {recentChats.map((chat) => (
                    <Link
                      key={chat.id}
                      href={`/cruise/agents/${agentId}/chat?session=${chat.id}`}
          ...
          <Card>
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-4 py-3 border-b">
                ...
                <Link href={`/cruise/agents/${agentId}/runs`} className="text-micro text-primary font-medium hover:underline">
                  View all
                </Link>
              </div>
              {recentRuns.length === 0 ? (
