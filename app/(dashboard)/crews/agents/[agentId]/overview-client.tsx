  ...
  if (error || !agent) {
    return (
      <div className="p-6">
        ...
        >
          <div className="mt-4">
            <Link href="/crews" className="text-micro font-medium text-primary hover:underline">
              Back to Crews
            </Link>
          </div>
        </EmptyState>
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        <StatMiniCard
          href={`/crews/agents/${agentId}/runs`}
          icon={Zap}
          label="Runs"
          value={totalRuns}
        ...
        />
        <StatMiniCard
          href={`/crews/agents/${agentId}/sessions`}
          icon={MessagesSquare}
          label="Sessions"
        ...
        />
        <StatMiniCard
          href={`/crews/agents/${agentId}/tools?section=skills`}
          icon={Puzzle}
          label="Skills"
        ...
        />
        <StatMiniCard
          href={`/crews/agents/${agentId}/tools?section=credentials`}
          icon={KeyRound}
          label="Credentials"
        ...
        />
        <StatMiniCard
          href={`/crews/agents/${agentId}/workspace?pane=files`}
          icon={FileText}
          label="Files"
          value="\u2014"
          ...
          <Card>
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-4 py-3 border-b">
                ...
                <Link href={`/crews/agents/${agentId}/chat`} className="text-micro text-primary font-medium hover:underline">
                  View all
                </Link>
              </div>
              {recentChats.length === 0 ? (
                ...
                <div className="divide-y">
                  {recentChats.map((chat) => (
                    <Link
                      key={chat.id}
                      href={`/crews/agents/${agentId}/chat?session=${chat.id}`}
          ...
          <Card>
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-4 py-3 border-b">
                ...
                <Link href={`/crews/agents/${agentId}/runs`} className="text-micro text-primary font-medium hover:underline">
                  View all
                </Link>
              </div>
              {recentRuns.length === 0 ? (
