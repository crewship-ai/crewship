...
function IntegrationsWorkspaceGate() {
  ...
  if (loading) {
    return (
      <div className="flex h-[calc(100dvh-48px-var(--mobile-tab-bar-h))] flex-col gap-4 bg-background p-4 md:p-6">
  ...
  if (!workspaceId) {
    return (
      <div className="flex h-[calc(100dvh-48px-var(--mobile-tab-bar-h))] items-center justify-center bg-background">
...
function LegacyIntegrationsPage() {
  ...
  if (wsLoading || loading) {
    return (
      <div className="p-4 md:p-6 space-y-4 bg-background min-h-[calc(100dvh-48px-var(--mobile-tab-bar-h))]">
  ...
  return (
    <div className="p-4 md:p-6 pb-10 space-y-4 bg-background min-h-[calc(100dvh-48px-var(--mobile-tab-bar-h))]">
      {/* ── Header ─────────────────────────────────────────────── */}
