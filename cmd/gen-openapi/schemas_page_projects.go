...
func pageProjectSchemaCatalog() map[string]DomainSchema {
	...
	reviewBaseline := map[string]any{"type": "object", "required": []string{"publication_version", "published", "definition_digest", "definition", "excluded_panels", "source_revision", "git_commit", "source_available", "source_unavailable_reason"}, "properties": map[string]any{
