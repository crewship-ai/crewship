...
var Crews = []CrewDef{
	{
		...
		RuntimeImage:       "mcr.microsoft.com/devcontainers/base:bookworm",
		DevcontainerConfig: `{"image":"mcr.microsoft.com/devcontainers/base:bookworm","features":{` + baseFeatures + `,"ghcr.io/devcontainers/features/github-cli:1":{}}}`,
	...
	},
	{
		...
		RuntimeImage:       "mcr.microsoft.com/devcontainers/base:bookworm",
		DevcontainerConfig: `{"image":"mcr.microsoft.com/devcontainers/base:bookworm","features":{` + baseFeatures + `,"ghcr.io/devcontainers/features/python:1":{}}}`,
	},
	{
		Name: "DevOps", Slug: "devops",
		Color: "#EF4444", Icon: "server",
		RuntimeImage:       "mcr.microsoft.com/devcontainers/base:bookworm",
		DevcontainerConfig: `{"image":"mcr.microsoft.com/devcontainers/base:bookworm","features":{` + baseFeatures + `,"ghcr.io/devcontainers/features/docker-in-docker:2":{},"ghcr.io/devcontainers/features/kubectl-helm-minikube:1":{}}}`,
