...
- Agent stop now waits for runtime confirmation instead of merely changing the displayed status; direct agent execs have an isolated, stoppable process identity.
