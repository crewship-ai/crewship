...
- **Routine Edit keeps combined changes in the draft.** Editing a name and inputs together no longer changes the published recipe before saving the draft. Unavailable draft baselines block saves visibly; input edits preserve identity already authored in the draft, and unverified script files are labelled consistently in Edit.
