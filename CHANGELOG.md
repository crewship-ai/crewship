...
### Fixed
- Integration validation: issue updates reject an assignee type without an assignee, preserving owner/delegate identity; backup response schemas accept the nullable diagnostic lists the server actually emits. (#2615)
