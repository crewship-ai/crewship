...
- Pending guaranteed-memory writes are reconciled after database migration and before the server accepts requests. Startup now fails if an intent cannot be recovered, instead of admitting another writer over an unresolved file. (#2643)
