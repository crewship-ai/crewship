...
//   6. Restart succeeds.
//
// Designed to run against `crewship-dev` (or any deployment with a real
...
test.describe("Toolbar provisioning popover — end-to-end", () => {
  test.skip(
    ...
    "Provisioning e2e requires a live backend with Docker; set PLAYWRIGHT_BASE_URL=http://crewship-dev.unifylab.cz:3001 to run.",
  )
