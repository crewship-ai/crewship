...
test.describe("Agent Overview", () => {
  test("shows CLI adapter icon and label", async ({ page }) => {
    await page.locator("a[href*='/crews/agents/']").first().click()
    await page.waitForURL("**/crews/agents/**")
...
test.describe("Agent Settings", () => {
  async function goToAgentSettings(page: any) {
    ...
    const agentCard = page.locator("a[href^='/crews/agents/']").filter({ hasText: /Idle|Running|Stopped|Error/ }).first()
