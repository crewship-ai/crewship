...
export interface FleetSelectionUpdate {
  agent?: string | null
  crew?: string | null
}
...
export interface FleetSelection {
  ...
  update: (updates: FleetSelectionUpdate) => void
...
/**
 * URL-driven selection for the Fleet page. Reads/writes `?agent=<slug>` and
