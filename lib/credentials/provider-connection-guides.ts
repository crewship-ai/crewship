...
export const PROVIDER_CONNECTION_GUIDES = {
  ...
  OPENCODE_GO: { url: "https://opencode.ai/auth", docs: "https://opencode.ai/docs/go/", instruction: "Subscribe to Go in your OpenCode workspace, then copy your API key and paste it below.", note: "Use with the OpenCode runner and an opencode-go/ model. Go has subscription usage limits. OpenCode’s Use balance option can charge your Zen balance after those limits; manage it in the OpenCode console. One member per OpenCode workspace can subscribe to Go." },
  OPENCODE: { url: "https://opencode.ai/auth", docs: "https://opencode.ai/docs/zen/", instruction: "Add billing in your OpenCode workspace, create an API key, then paste it below.", note: "Use with the OpenCode runner and an opencode/ model. Zen charges by usage. Manage credits, auto-reload, member limits and model access in the OpenCode console." },
  ZAI_CODING_PLAN: { url: "https://z.ai/manage-apikey/apikey-download", docs: "https://docs.z.ai/devpack/tool/opencode", instruction: "Subscribe to the GLM Coding Plan at Z.AI, create an API key, then paste it below.", note: "Use with the OpenCode runner and a zai-coding-plan/ model. This is the Coding Plan subscription, not metered Z.AI API credit — a different product with its own key, endpoint and limits. Crewship does not infer remaining plan quota. Do not reuse a metered Z.AI key here." },
