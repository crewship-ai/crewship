...
go test -p 1 -json -count=1 -timeout=10m \
  ...
  -run '^(TestDockerPreviewBuildIntegration|TestPageBuildDockerRoundTrip|TestPageProjectMCPDockerIntegration|TestSeedPageAppLifecycle|TestOperationsCollectorPayloads|TestOperationsCollectorFleetTelemetry|TestAcceptance_PageProjectGitHistoryRestore)$' \
...
required = {
    ...
    "TestOperationsCollectorFleetTelemetry",
