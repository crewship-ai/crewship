...
tests=(test-memory.sh test-delegation.sh test-crew-links.sh test-notifications.sh test-orchestration.sh test-credentials.sh test-keeper.sh test-keeper-config.sh)
