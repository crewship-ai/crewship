...
# uc: pack-ci-watch
# title: Pack: nightly CI watch — probe, report, verify against GitHub
# needs: github
# minutes: 3
#
# One of the three demo packs `crewship seed` installs (docs/guides/
# demo-packs.mdx). The contract is `crewship seed verify --pack ci-watch`:
...
# Needs SEED_GITHUB_TOKEN (read-only: actions:read + repo read) at seed time.
