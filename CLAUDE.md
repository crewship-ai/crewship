...
- **Multi-instance (`dev 1` / `dev 2` / `dev 3`):** parallel checkouts on the **same VM** — they differ by directory and port, NOT by IP/host. All four reach via `ssh crewship-dev` and share `192.168.1.201`. Layout:
